...
(function () {
     ...
     */
	var URL = P8CONFIG.RESOURCE+'/ueditor/';
	var Resource = P8CONFIG.attachment_storate_type == 'relative_url' ? '' : P8CONFIG.RESOURCE_VICE;
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl: P8CONFIG.url+'/ueditor/' + "php/controller.php?system="+SYSTEM+"&module="+MODULE 
        ...
        , toolbars: [[
            ...
            'print', 'preview', 'searchreplace', 'drafts', 'help', 'wordupload', 'excelupload', 'pdftoimage','pdfupload'
        ]]
		...
		,catcherUrlPrefix:P8CONFIG.attachment_url
		...
		,whitList: {
			...
			i:      ['class', 'style'],
			img:    ['src', 'alt', 'poster', 'title', 'width', 'height', 'id', '_src', '_url', 'loadingclass', 'class', 'data-latex', 'vspace', 'border' ,'anchorname','word_img', 'style'],
			ins:    ['datetime'],
			li:     ['class', 'style' , '_src'],
			mark:   [],
			nav:    [],
