...
UE.I18N['en'] = {
    'labelMap':{
        ...
        'charts': 'charts','drafts': 'Load from Drafts', 'wordupload':'Docx Only', 'pdfupload':'PDF Only','excelupload':'Xlsx Only','pdftoimage':'PDF to JPEG'
    },
    'insertorderedlist':{
        'num':'1,2,3...',
        'num1':'1),2),3)...',
	...
	'pdfupload':{
        'static':{
            'lang_tab_upload': 'Upload PDF',
            'lang_tab_online': 'Online',
            'lang_start_upload':"Start upload",
            'lang_drop_remind':"You can drop files here, a single maximum of 300 files"
        },
        'uploadSelectFile':'Select PDF File',
        'uploadAddFile':'Add File',
        'uploadStart':'Start Upload',
        'uploadPause':'Pause Upload',
        'uploadContinue':'Continue Upload',
