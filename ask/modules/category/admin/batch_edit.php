...
if(REQUEST_METHOD == 'GET'){
	...
	$data['category_logo'] && $data['category_logo'] = attachment_url($data['category_logo'],false,true);
	$data['category_banner'] && $data['category_banner'] = attachment_url($data['category_banner'],false,true);
