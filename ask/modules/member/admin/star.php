...
$select->from($core->TABLE_.'member AS M', 'M.username,M.name,M.role_id,M.status as verify,M.id');
$select->left_join($this_module->table . ' AS E', 'E.expert,E.star,E.item_count,E.solve_item_count,E.reply_count,E.fav_count,E.last_ask_time,E.last_reply_time', 'M.username=E.username');
$select->in('E.star', 1);
