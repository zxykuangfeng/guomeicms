...
$host = isset($_POST['host']) ? clear_special_char($_POST['host']) : '';
$port = isset($_POST['port']) ? intval(clear_special_char($_POST['port'])) : 21;
$user = isset($_POST['user']) ? clear_special_char($_POST['user']) : '';
$password = isset($_POST['password']) ? $_POST['password'] : '';
$dir = isset($_POST['dir']) ? clear_special_char($_POST['dir']) : '';
$timeout = isset($_POST['timeout']) ? intval($_POST['timeout']) : 0;
