...
function valid_data(&$POST){
	...
	$data['option']['place_holder_width'] = $data['option']['place_holder_width'] >= 300 ? 300 : $data['option']['place_holder_width'];
	$data['option']['place_holder_width'] = $data['option']['place_holder_width'] <= 60 ? 60 : $data['option']['place_holder_width'];
	$data['option']['place_holder_height'] = $data['option']['place_holder_height'] >= 100 ? 100 : $data['option']['place_holder_height'];
	$data['option']['place_holder_height'] = $data['option']['place_holder_height'] <= 30 ? 30 : $data['option']['place_holder_height'];
	
	
	$data['variable'] = empty($POST['option']['var_fields']) ? 0 : 1;
	//模板
	if(!empty($data['option']['tplcode']) && strlen($data['option']['tplcode']) > 10){
		if(strpos($data['option']['tplcode'],'<!--{php168}-->') === false || strpos($data['option']['tplcode'],'<!--{/php168}-->') === false) message('label_template_syntax_error');
	}
	...
	quicklink	链接
	*/
	$types = array('sql', 'module_data', 'html', 'slide', 'image', 'flash','quicklink');
