...
/**
* 直推数据到分站栏目,只提供AJAX POST调用
**/

$this_controller->check_admin_action('cluster_push') or exit('[]');
...
if(REQUEST_METHOD == 'GET'){
	...
	if(current($push_site)){		
		...
		$verify = $item_controller->check_category_action('autoverify', $cid, current($push_site));
