...
if(REQUEST_METHOD == 'GET'){
	...
	include template($this_module, 'statistic_author', 'admin');
	...
	$cid = intval($cid);	
	if($act=='query'){
		$data = $this_module->getStatic_author($year,$month,$cid,$model);
	...
	elseif($act=='download'){
		$static = $this_module->getStatic_author($year,$month,$cid,$model,0,true);
		exit;
	}
