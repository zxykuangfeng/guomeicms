...
$sql .= "
ALTER TABLE `$main_table` CHANGE `verifier` `verifier` VARCHAR(50) NOT NULL DEFAULT '';
ALTER TABLE `$unverified_table` CHANGE `verifier` `verifier` VARCHAR(50) NOT NULL DEFAULT '';
";
