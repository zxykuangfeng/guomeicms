function showMedia(o,divid){
	...
	case '.rmvb':
	case '.ra':
		s = ie8?RMPlayer(o):html5Video(o);
		break;
	case '.swf':
		s = ie8?FlashPlayer(o):html5Video(o);
		break;
	case '.flv':
	case '.mp4':
		s = ie8?cmstopPlayer(o):html5Video(o);
		break;
	default:
		s = iframeshow(o);
	}
...
function html5Video(o){
	return '<video id="'+ o.id +'" src="'+ o.url +'" poster="'+o.image+'" controls="controls" width="' + o.width + '" height="' + o.height + '">正在加载中....</video>';
}

function iframeshow(o){
	
	return '<iframe width="' + o.width + '" height="' + o.height + '" src='+ o.url +' frameborder=0></iframe>';
}
