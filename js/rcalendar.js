...
function rcalendar(text, mode, retfunction,follow = false) { //文本域对象, 模式(dateonly,full), 选择日期后的事件函数(函数是新时间的Date对象)
	...
	if (!div_rcalendar) { //如果不存在，则初始化创建它
		...
		if (document.compatMode == "BackCompat" && navigator.userAgent.indexOf("MSIE") != -1) {
			...
			css += ".rweek {width:27px; height:20px;line-height:20px; float:left; text-align:center; background:#CCCCCC; color:#FFFFFF; overflow:hidden;}";
			css += ".rdate {width:27px; height:20px;line-height:20px; float:left; text-align:center; overflow:hidden; cursor:pointer;}";
			...
			css += "#ryear_add span{padding:0px; height:12px; width:18px;float:left; overflow:hidden; cursor:pointer;text-align:center;}";
			...
			css += ".rmonth {width:25px; height:20px; overflow:hidden; float:left; cursor:pointer;}";
			...
			css += ".rhour {padding:0 7px; background:#B0B0B0; color:#FFFFFF; height:18px; overflow:hidden; float:left; cursor:pointer;}";
			css += "#rminutes {width:104px; height:54px; overflow:hidden;}";
			css += ".rminute {padding:0px 7px; background:#B0B0B0; color:#FFFFFF; height:18px; overflow:hidden; float:left; cursor:pointer;}";
			css += "#rseconds {width:104px; height:54px; overflow:hidden;}";
			css += ".rsecond {padding:0px 7px; background:#B0B0B0; color:#FFFFFF; height:18px; overflow:hidden; float:left; cursor:pointer;}";
			...
			css += "#rcalendar {min-width:190px; height:190px; background:#FFFFFF; font-size:12px; font-family:宋体; border:1px solid #999999; padding:4px; overflow:hidden;}";
			css += "#rcalendar_ym {width:190px; height:14px; overflow:hidden; margin-bottom:4px;}";
			css += "#rcalendar_y {width:48px; float:left; font-weight:bold; color:#777777; padding-left:2px;}";
			css += "#rcalendar_m {width:50px; float:left; font-weight:bold; color:#777777;}";
			css += "#rweeks {width:190px; height:20px; overflow:hidden;}";
			css += "#rdates {width:190px; height:120px; overflow:hidden;}";
			css += ".rweek {width:27px; height:20px;line-height:20px;float:left; text-align:center; background:#6394bd; color:#FFFFFF; overflow:hidden;}";
			css += ".rdate {width:27px; height:20px;line-height:20px;float:left; text-align:center; overflow:hidden; cursor:pointer;}";
			css += "#ryears {background:#B0B0B0; border:1px solid #999999; border-top:0px; color:#FFFFFF; text-align:center;}";
			css += ".ryear {padding:3px 3px 3px 3px; height:24px; width:34px; overflow:hidden; cursor:pointer; font-weight:bold;}";
			css += "#ryear_add {padding:0px; height:12px; width:36px; overflow:hidden; cursor:pointer;}";
			css += "#ryear_add span{padding:0px; height:12px; width:18px;float:left; overflow:hidden; cursor:pointer;text-align:center;}";
	...
	if(follow)
		div_rcalendar.style.top = (left_top[1] + rtext_date.offsetHeight - 225) + "px";
	else
