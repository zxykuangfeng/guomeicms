...
<style type="text/css">
#play_{$label['id']}{margin:0;float:left;width:{$swidth}px;height:{$sheight}px; overflow:hidden;}
...
#play_{$label['id']} .playNum{width:{$swidth}px;overflow:hidden;margin:{$mtop}px 0px 0 0px;z-index:3; text-align:right;position:absolute;height:25px;}
