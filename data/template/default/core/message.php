...
.container { padding:15px; background:#fff;text-align:center; }
...
<div class="container">
<ul class="h1">
<li class="h3"><b>{$P8LANG['prompt_message']}</b></li>
<li class="h2"><a href="javascript:window.close()"><img  border="none" src="{$RESOURCE}/skin/default/core/alonepage/x.gif"></a></li>
</ul>
EOT;
if(empty($messagedb)){
print <<<EOT
...
<ul class="buttons">
<img  border="none" src="{$RESOURCE}/skin/default/core/alonepage/tip.gif"> 
EOT;
if($message){
print <<<EOT
{$message}
