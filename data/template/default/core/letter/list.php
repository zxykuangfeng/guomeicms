...
$__label['letter_tab1_tit1'] = $LABEL->display('letter_tab1_tit1');
$__label['letter_tab1_con'] = $LABEL->display('letter_tab1_con');
$__label['letter_tab2_tit1'] = $LABEL->display('letter_tab2_tit1');
$__label['letter_tab2_tit2'] = $LABEL->display('letter_tab2_tit2');
$__label['letter_tab2_tit3'] = $LABEL->display('letter_tab2_tit3');
$__label['letter_tab2_con2'] = $LABEL->display('letter_tab2_con2');
$__label['letter_tab2_more2'] = $LABEL->display('letter_tab2_more2');
$__label['letter_tab2_con3'] = $LABEL->display('letter_tab2_con3');
$__label['letter_tab2_more3'] = $LABEL->display('letter_tab2_more3');
$__label['letter_tab3_tit1'] = $LABEL->display('letter_tab3_tit1');
$__label['letter_tab3_con1'] = $LABEL->display('letter_tab3_con1');
$__label['letter_tab4_tit1'] = $LABEL->display('letter_tab4_tit1');
$__label['letter_tab4_con1'] = $LABEL->display('letter_tab4_con1');
$__label['letter_tab5_tit1'] = $LABEL->display('letter_tab5_tit1');
$__label['letter_tab5_con1'] = $LABEL->display('letter_tab5_con1');
$__label['letter_nav_con1'] = $LABEL->display('letter_nav_con1');
$__label['letter_tips_tit1'] = $LABEL->display('letter_tips_tit1');
$__label['letter_tips_con1'] = $LABEL->display('letter_tips_con1');
...
<div class="hd">
<ul>
<li>{$__label['letter_tab1_tit1']}</li>
</ul>
</div>
<div class="optext">{$__label['letter_tab1_con']}</div>
<div class="bd">
<div class="mtab">
<div class="inHd">
<ul>
...
<li>{$__label['letter_tab2_tit1']}</li>
<li>{$__label['letter_tab2_tit2']}</li>
<li>{$__label['letter_tab2_tit3']}</li>
EOT;
}else{
print <<<EOT
...
<tr>
<td class="ltitle"><a href="$row[url]" title="$row[title]" target="_blank">$row[title_s]
EOT;
if($row[undisplay]){
print <<<EOT
<span style="color:red;"> (密)</span>
EOT;
}
print <<<EOT
</a>[
...
<tr>
<td id="page" class="no_right" colspan="6"> {$pages}  </td>
</tr>
</table>
</div>
</div>
...
<div class="nlist">
{$__label['letter_tab2_con2']}
</div>
<div class="more">{$__label['letter_tab2_more2']}</div>
</div>
<div class="tablist" style="display:none;">
<div class="nlist">
{$__label['letter_tab2_con3']}
</div>
<div class="more">{$__label['letter_tab2_more3']}</div>
</div>
</div>
</div>
<div class="mtab">
<div class="inHd">
<ul>
<li>{$__label['letter_tab3_tit1']}</li>
</ul>
</div>
<div class="inBd">
{$__label['letter_tab3_con1']}
</div>
</div>
<div class="mtab">
<div class="inHd">
<ul>
<li>{$__label['letter_tab4_tit1']}</li>
</ul>
</div>
<div class="inBd">
{$__label['letter_tab4_con1']}
</div>
</div>
<div class="mtab">
<div class="inHd">
<ul>
<li>{$__label['letter_tab5_tit1']}</li>
</ul>
</div>
<div class="inBd">
{$__label['letter_tab5_con1']}
</div>
</div>
</div>
</div>
...
<div class="tj">
<div class="mailtotal">共有来信：<span>{$alldata[0]}</span> 条</div>
<div class="mailresponsed">回复来信：<span>$alldata[2]</span> 条</div>
</div>
</div>
<div class="col-md-3 col-sm-4 col-xs-12">
<div class="lyxz"><a href="javascript:void(0);" class="click">来信须知</a></div>
</div>
</div>
</div>
</div>
...
<h3>{$__label['letter_tips_tit1']}</h3>
<span class="close">Ｘ</span>
</div>
<div class="bd">
{$__label['letter_tips_con1']}
</div>
</div>
</div>
</div>
...
jQuery(".mtab").slide({ titCell:".inHd li",mainCell:".inBd" });
/* 外层outBox左滚动切换 */
jQuery(".optab").slide({ effect:"fade" });
</script>

<script type="text/javascript">
$(document).ready(function () {
$('.close').click(function () {
$('.backdrop ,.tipsbox').hide();
$('body').removeClass('open');
});
$('.click').click(function () {
$('.backdrop ,.tipsbox').show();
$('body').addClass('open');
});
})
