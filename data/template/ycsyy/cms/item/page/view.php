...
$__label = array();
$__label['bigbanner_daohan'] = $LABEL->display('bigbanner_daohan');
$__label['lianjie20'] = $LABEL->display('lianjie20');
...
print <<<EOT
&nbsp;  发布人：{$data['username']}&nbsp; 浏览量：<span class="item_views">$data[views]</span>
<a href="javascript:void(0)" onclick="javascript:window.print()">打印本文</a> <span id="operation" style="display: none; cursor: pointer;color:#0040ff;margin-left:15px;">{$P8LANG['operation']}>></span>
</div>
...
$(this).attr('src', '$this_router-digg?iid=$data[id]');
});
});
</script>
EOT;
...
<div class="change">
<ul>
<li><font style="color:red">上一篇：</font>
EOT;
...
<li><font style="color:red">下一篇：</font>
EOT;
