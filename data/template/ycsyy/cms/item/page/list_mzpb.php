...
$__label['list_guide_con1'] = $LABEL->display('list_guide_con1');
...
<div class="guide-box">
<div class="slider-guide clearfix">
{$__label['list_guide_con1']}
</div>
</div>
...
<ul class="tabs-nav1 row" id="tabs">
EOT;
$__t_foreach = @$stepcat;
if(!empty($__t_foreach)){
foreach($__t_foreach as $v){
...
<li class="col-md-2 col-sm-3 col-xs-12 cid_{$v['id']} 
EOT;
if($cid == $v['id']){
print <<<EOT
now
...
<div class="docker-visit">
<div class="more pull-right">
<span id="operation" style="display: none; cursor: pointer;color:#0040ff;">{$P8LANG['operation']}>></span>
</div>
<div class="artcon">
$data[content]
</div>
...
<script type="text/javascript">
$(".slider-guide .slick-guide").slick({
autoplay: false,
infinite: false,
slidesToShow: 5,
slidesToScroll: 1,
