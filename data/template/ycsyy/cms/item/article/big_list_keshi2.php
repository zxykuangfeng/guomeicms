...
$__label['list_zj_tt1'] = $LABEL->display('list_zj_tt1');
$__label['list_zj_more1'] = $LABEL->display('list_zj_more1');
$__label['list_zj_con1'] = $LABEL->display('list_zj_con1');
...
<div class="depart-img"><img src="{$CAT[frame]}"/></div>		
</div>
<div class="col-md-7 col-sm-7 col-xs-12">
<div class="intro-right">
<div class="intro-title">
$CAT[name]<span class="more pull-right"><a target="_blank" href="{$CAT[CONFIG][linkurl]}">更多 &gt; </a></span>
</div>
...
<a href="/html/873/"><img src="{$SKIN}images/intro2.png"></a>
</div>
</div>
</div>
</div>
<div class="team">
<div class="intro-title mb20">
{$__label['list_zj_tt1']}<span class="more pull-right">{$__label['list_zj_more1']}</span>
</div>
<div class="row">
{$__label['list_zj_con1']}
</div>
</div>
</div>
</div>
