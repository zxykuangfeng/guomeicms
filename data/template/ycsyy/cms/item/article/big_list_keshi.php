...
$__label['list_keshi1_tt1'] = $LABEL->display('list_keshi1_tt1');
$__label['list_keshi1_con1'] = $LABEL->display('list_keshi1_con1');
$__label['list_keshi1_tt2'] = $LABEL->display('list_keshi1_tt2');
$__label['list_keshi1_con2'] = $LABEL->display('list_keshi1_con2');
$__label['list_keshi1_pic1'] = $LABEL->display('list_keshi1_pic1');
$__label['list_keshi1_pic2'] = $LABEL->display('list_keshi1_pic2');
$__label['list_keshi1_pic3'] = $LABEL->display('list_keshi1_pic3');
$__label['list_keshi1_pic4'] = $LABEL->display('list_keshi1_pic4');
$__label['list_keshi1_pic5'] = $LABEL->display('list_keshi1_pic5');
...
<div class="column-depart mb40">
<div class="depart-box">
<div class="depart-title">{$__label['list_keshi1_tt1']}</div>
<div class="depart-item">
{$__label['list_keshi1_con1']}
</div>
</div>
<div class="depart-box">
<div class="depart-title">{$__label['list_keshi1_tt2']}</div>
<div class="depart-item">
{$__label['list_keshi1_con2']}
</div>
</div>
</div>
<div class="row">
...
<div class="img-box2 img1 mb20">
{$__label['list_keshi1_pic1']}
</div>
</div>
<div class="col-md-6 col-sm-6 col-xs-12">
<div class="img-box2 img2 mb20">
{$__label['list_keshi1_pic2']}
</div>
</div>
</div>
<div class="row">
<div class="col-md-6 col-sm-6 col-xs-12">
<div class="img-box2 img3 mb20">
{$__label['list_keshi1_pic3']}
</div>
</div>
<div class="col-md-6 col-sm-6 col-xs-12">
<div class="img-box2 img4 mb20">
{$__label['list_keshi1_pic4']}
</div>
</div>
</div>
</div>
<div class="col-md-4 col-sm-4 col-xs-12">
<div class="img-box3 mb20">
{$__label['list_keshi1_pic5']}
</div>
</div>
</div>
</div>
