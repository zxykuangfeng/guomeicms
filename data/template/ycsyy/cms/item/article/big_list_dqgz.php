...
$__label['list_dqgz_con'] = $LABEL->display('list_dqgz_con');
$__label['list_dqgz_con1'] = $LABEL->display('list_dqgz_con1');
...
<div class="column-title mb10 clearfix">
$CAT[name]
</div>
<div class="row">
<div class="col-md-3 col-sm-3 col-xs-12">
<div class="party-box">{$__label['list_dqgz_con']}</div>
</div>
<div class="col-md-9 col-sm-9 col-xs-12">
<div class="row">{$__label['list_dqgz_con1']}</div>
</div>
</div>
</div>
</div>
