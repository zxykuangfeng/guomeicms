...
$__label['list_zp_btn'] = $LABEL->display('list_zp_btn');
...
<div class="pull-right" style="line-height: 32px;margin: 30px 0 0;">{$__label['list_zp_btn']}</div>
</div>

<div class="column-title clearfix">
$CAT[name]
<div class="column-more hidden-xs pull-right">
EOT;
if($add_enable){
print <<<EOT
