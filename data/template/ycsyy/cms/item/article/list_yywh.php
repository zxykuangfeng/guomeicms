...
$__label['list_yywh_pic1'] = $LABEL->display('list_yywh_pic1');
$__label['list_yywh_pic2'] = $LABEL->display('list_yywh_pic2');
$__label['list_yywh_pic3'] = $LABEL->display('list_yywh_pic3');
$__label['list_yywh_box1_tt1'] = $LABEL->display('list_yywh_box1_tt1');
$__label['list_yywh_box1_more1'] = $LABEL->display('list_yywh_box1_more1');
$__label['list_yywh_con1'] = $LABEL->display('list_yywh_con1');
$__label['list_yywh_con2'] = $LABEL->display('list_yywh_con2');
...
<div class="column-title mb20 clearfix">
$CAT[name]
</div>
<div class="row">
<div class="col-md-4 col-sm-4 col-xs-12">
<div class="img-box mb20">{$__label['list_yywh_pic1']}</div>
</div>
<div class="col-md-4 col-sm-4 col-xs-12">
<div class="img-box mb20">{$__label['list_yywh_pic2']}</div>
</div>
<div class="col-md-4 col-sm-4 col-xs-12">
<div class="img-box mb20">{$__label['list_yywh_pic3']}</div>
</div>
</div>
<div class="part-list2 pt20">
<div class="list-title mb10 clearfix">
<div class="title pull-left">{$__label['list_yywh_box1_tt1']}</div> 
<span class="more pull-right"> 
{$__label['list_yywh_box1_more1']}
</span>
</div>
<div class="row row30">
<div class="col-md-6 col-sm-6 col-xs-12 col-pd-30">
<div class="img-box mb20">{$__label['list_yywh_con1']}</div>
</div>
<div class="col-md-6 col-sm-6 col-xs-12 col-pd-30">
<div class="list-content mb20">{$__label['list_yywh_con2']}</div>
</div>
</div>
</div>
</div>
