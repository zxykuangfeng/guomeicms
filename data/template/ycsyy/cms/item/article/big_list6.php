...
$__label['big_list6_tt1'] = $LABEL->display('big_list6_tt1');
$__label['big_list6_more1'] = $LABEL->display('big_list6_more1');
$__label['big_list6_con1'] = $LABEL->display('big_list6_con1');
$__label['big_list6_tt2'] = $LABEL->display('big_list6_tt2');
$__label['big_list6_more2'] = $LABEL->display('big_list6_more2');
$__label['big_list6_con2'] = $LABEL->display('big_list6_con2');
$__label['big_list6_tt3'] = $LABEL->display('big_list6_tt3');
$__label['big_list6_more3'] = $LABEL->display('big_list6_more3');
$__label['big_list6_con3'] = $LABEL->display('big_list6_con3');
...
<div class="title pull-left">{$__label['big_list6_tt1']}</div> 
<span class="more pull-right"> 
{$__label['big_list6_more1']}
</span>
</div>
<div class="list-main">
<div class="list-content">
{$__label['big_list6_con1']}
</div>
</div>
</div>
</div>
...
<div class="part-list4">
<div class="list-title clearfix">
<div class="title pull-left">{$__label['big_list6_tt2']}</div> 
<span class="more pull-right"> 
{$__label['big_list6_more2']}
</span>
</div>
<div class="list-main">
<div class="list-content">
{$__label['big_list6_con2']}
</div>
</div>
</div>
<div class="part-list4">
<div class="list-title clearfix">
<div class="title pull-left">{$__label['big_list6_tt3']}</div> 
<span class="more pull-right"> 
{$__label['big_list6_more3']}
</span>
</div>
<div class="list-main">
<div class="list-content">
{$__label['big_list6_con3']}
</div>
</div>
</div>
</div>
