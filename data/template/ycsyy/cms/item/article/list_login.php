...
$__label = array();
$__label['list_login_title1'] = $LABEL->display('list_login_title1');
$__label['list_login_con1'] = $LABEL->display('list_login_con1');
$__label['list_login_title2'] = $LABEL->display('list_login_title2');
$__label['list_login_con2'] = $LABEL->display('list_login_con2');
$__label['list_login_title3'] = $LABEL->display('list_login_title3');
$__label['list_login_con3'] = $LABEL->display('list_login_con3');
$__label_empty = true;
...
<div id="header_t" class="show"><span id="header_login"><script type="text/javascript" src="{$core->U_controller}/core/member-login?style=list&id=header_login"></script></span></div>
</div>
<div class="layout">
<h3>{$__label['list_login_title1']}</h3>
<div class="list">
{$__label['list_login_con1']}
</div>
<h3>{$__label['list_login_title2']}</h3>
<div class="list">
{$__label['list_login_con2']}
</div>
<h3>{$__label['list_login_title3']}</h3>
<div class="list">
{$__label['list_login_con3']}
</div>
</div>
<div class="footer">
<div class="footinner clearfix">
<div class="copyright">
<p>{$core->CONFIG['copyright']}</p>
</div>
</div>
</div>
</div>
