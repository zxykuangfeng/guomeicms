...
CREATE TABLE `p8_admin_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`,`timestamp`)
) ENGINE=MyISAM AUTO_INCREMENT=7407 DEFAULT CHARSET=utf8;
...
CREATE TABLE `p8_cms_item` (
  ...
  KEY `uid` (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=3902 DEFAULT CHARSET=utf8;
...
CREATE TABLE `p8_forms_item` (
  ...
  KEY `timestamp` (`timestamp`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=4668 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=21055 DEFAULT CHARSET=utf8;
