...
CREATE TABLE `p8_admin_menu` (
  ...
  `menu_sys` varchar(20) NOT NULL DEFAULT 'main',
  PRIMARY KEY (`id`),
...
CREATE TABLE `p8_cms_item` (
  ...
  `author_x` varchar(50) NOT NULL DEFAULT '',
  `author_y` varchar(50) NOT NULL DEFAULT '',
  `author_z` varchar(50) NOT NULL DEFAULT '',
  `authority` varchar(255) NOT NULL DEFAULT '',
  `editer` varchar(50) NOT NULL DEFAULT '',
  `username` varchar(20) NOT NULL DEFAULT '',
  ...
  `timestamp` int(10) unsigned NOT NULL DEFAULT '0',
  `verify_frame` varchar(1255) NOT NULL DEFAULT '',
  `attachment_pdf` varchar(255) DEFAULT '',
...
CREATE TABLE `p8_cms_item_down_addon` (
  ...
  `totaldown` mediumint(5) NOT NULL DEFAULT '0',
  `custom_f` varchar(255) NOT NULL DEFAULT '',
  `custom_g` varchar(255) NOT NULL DEFAULT '',
  `custom_h` varchar(255) NOT NULL DEFAULT '',
  `custom_i` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE `p8_cms_item_government_affairs_` (
  ...
  `seo_description` varchar(200) NOT NULL DEFAULT '',
  `label_postfix` varchar(50) NOT NULL DEFAULT '',
  `fileno` varchar(255) NOT NULL DEFAULT '',
  `editer` varchar(20) NOT NULL DEFAULT '',
  `create_time` int(10) unsigned NOT NULL DEFAULT '0',
  `indexno` varchar(255) NOT NULL DEFAULT '',
  `name` varchar(255) NOT NULL DEFAULT '',
  `issued` varchar(255) NOT NULL DEFAULT '',
  `sxlb` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `cid` (`cid`,`list_order`),
  KEY `cid_id` (`cid`,`id`),
  KEY `uid` (`uid`)
...
CREATE TABLE `p8_cms_item_government_affairs_addon` (
  ...
  `toushu` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `iid` (`iid`,`page`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `p8_cms_item_govopen_` (
  ...
  `label_postfix` varchar(50) NOT NULL DEFAULT '',
  `config` varchar(1255) NOT NULL DEFAULT '',
  `duixiang` tinyint(3) NOT NULL DEFAULT '0',
  `geshi` tinyint(3) NOT NULL DEFAULT '0',
  `jigou` tinyint(3) NOT NULL DEFAULT '0',
  `shengming` tinyint(3) NOT NULL DEFAULT '0',
  `suoyin` varchar(255) NOT NULL DEFAULT '',
  `ticai` tinyint(3) NOT NULL DEFAULT '0',
  `wenhao` varchar(255) DEFAULT '',
  `custom_a` varchar(255) NOT NULL DEFAULT '',
  `custom_b` varchar(255) NOT NULL DEFAULT '',
  `custom_c` varchar(255) NOT NULL DEFAULT '',
  `custom_d` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE `p8_cms_item_govopen_addon` (
  ...
  `timestamp` int(10) unsigned NOT NULL DEFAULT '0',
  `content` mediumtext NOT NULL,
  `xinxifenlei` varchar(50) NOT NULL DEFAULT '',
  `custom_f` varchar(255) NOT NULL DEFAULT '',
  `custom_g` varchar(255) NOT NULL DEFAULT '',
  `custom_h` varchar(255) NOT NULL DEFAULT '',
  `custom_i` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE `p8_cms_item_video_addon` (
  ...
  `timestamp` int(10) unsigned NOT NULL DEFAULT '0',
  `content` mediumtext NOT NULL,
  `video_height` smallint(5) NOT NULL DEFAULT '0',
  `video_url` varchar(255) DEFAULT '',
  `video_width` smallint(5) NOT NULL DEFAULT '0',
  `custom_f` varchar(255) NOT NULL DEFAULT '',
  `custom_g` varchar(255) NOT NULL DEFAULT '',
  `custom_h` varchar(255) NOT NULL DEFAULT '',
  `custom_i` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE `p8_cms_item_zlku_addon` (
  ...
  `timestamp` int(10) unsigned NOT NULL DEFAULT '0',
  `content` mediumtext NOT NULL,
  `copyright` tinyint(3) NOT NULL DEFAULT '0',
  `softlanguage` tinyint(3) NOT NULL DEFAULT '0',
  `softsize` varchar(10) NOT NULL DEFAULT '',
  `softurl` mediumtext NOT NULL,
  `totaldown` mediumint(5) NOT NULL DEFAULT '0',
  `custom_f` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE `p8_cms_statistic_cms_statistic_sites_content` (
  ...
  `unverified` int(10) NOT NULL DEFAULT '0',
...
CREATE TABLE `p8_cms_statistic_sites_content` (
  ...
  `unverified` int(10) NOT NULL DEFAULT '0',
  `timestamp` int(10) NOT NULL DEFAULT '0',
  `post_im` int(10) unsigned NOT NULL DEFAULT '0',
  `verified_im` int(10) unsigned NOT NULL DEFAULT '0',
  `views` int(10) unsigned NOT NULL DEFAULT '0',
  `views_im` int(10) unsigned NOT NULL DEFAULT '0',
  UNIQUE KEY `uk` (`year`,`month`,`site`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `p8_cms_wechat_pushlogs` (
  ...
  `description` varchar(255) NOT NULL DEFAULT '',
  `body` text,
  `push_at` varchar(512) NOT NULL DEFAULT '',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `aid` (`aid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `p8_filter_link` (
  ...
  `conn` tinyint(1) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `p8_forms_item` (
  ...
  KEY `timestamp` (`timestamp`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=5347 DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `p8_forms_item_bybd2`;
CREATE TABLE `p8_forms_item_bybd2` (
  `id` int(10) unsigned NOT NULL,
  `mingcheng` varchar(255) NOT NULL DEFAULT '',
  `lxr` varchar(255) NOT NULL DEFAULT '',
  ...
  `wangzhi` varchar(255) DEFAULT '',
  `beizhu` varchar(255) DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `p8_forms_item_bybd4` (
  `id` int(10) unsigned NOT NULL,
  `tibaoren` varchar(255) NOT NULL DEFAULT '',
  `chengdu` varchar(255) NOT NULL DEFAULT '',
  `baoxsx` varchar(255) NOT NULL DEFAULT '',
  `bxjtnr` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `p8_forms_item_bybd6` (
  `id` int(10) unsigned NOT NULL,
  `beizhu` varchar(255) DEFAULT '',
  `cpmc` varchar(255) NOT NULL DEFAULT '',
  `tibaoren` varchar(255) NOT NULL DEFAULT '',
  `yuefen` varchar(255) NOT NULL DEFAULT '',
  `sfzh` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `p8_forms_item_kehu` (
  `id` int(10) unsigned NOT NULL,
  `beizhu` varchar(255) DEFAULT '',
  `bum` varchar(255) NOT NULL DEFAULT '',
  `caigou` varchar(255) NOT NULL DEFAULT '',
  `csny` varchar(255) NOT NULL DEFAULT '',
  `czhm` varchar(255) NOT NULL DEFAULT '',
  `date` varchar(255) NOT NULL DEFAULT '',
  `date2` varchar(255) NOT NULL DEFAULT '',
  `email` varchar(255) DEFAULT '',
  `gaokao` varchar(255) NOT NULL DEFAULT '',
  `kaoshenghao` varchar(255) NOT NULL DEFAULT '',
  `khjb` varchar(255) NOT NULL DEFAULT '',
  `khlb` varchar(255) NOT NULL DEFAULT '',
  `khmc` varchar(255) NOT NULL DEFAULT '',
  `lianxiren` varchar(255) NOT NULL DEFAULT '',
  `QQ` varchar(255) DEFAULT '',
  `shouji` varchar(255) NOT NULL DEFAULT '',
  `tongxing` varchar(255) NOT NULL DEFAULT '',
  `wangzhi` varchar(255) DEFAULT '',
  `xingmin` varchar(255) NOT NULL DEFAULT '',
  `xingming` varchar(255) NOT NULL DEFAULT '',
  `year` varchar(255) NOT NULL DEFAULT '',
  `yuefen` varchar(255) NOT NULL DEFAULT '',
  `zycj` varchar(255) DEFAULT '',
...
CREATE TABLE `p8_forms_item_library` (
  ...
  `bookcase` varchar(255) NOT NULL DEFAULT '',
  `author` varchar(255) NOT NULL DEFAULT '',
  `press` varchar(255) NOT NULL DEFAULT '',
  `zhuangtai` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `p8_forms_item_project` (
  ...
  `sudi` varchar(255) DEFAULT '',
  `name` varchar(255) NOT NULL DEFAULT '',
  `leibie` varchar(255) NOT NULL DEFAULT '',
  `touzhi` varchar(255) NOT NULL DEFAULT '',
  `niandu` varchar(255) NOT NULL DEFAULT '',
  `bianhao` varchar(255) DEFAULT '',
  `lxdw` varchar(255) NOT NULL DEFAULT '',
  `xiangmuzhuangtai` varchar(255) DEFAULT '',
  `beizhu` longtext,
...
DROP TABLE IF EXISTS `p8_item_verify_log`;
...
) ENGINE=MyISAM AUTO_INCREMENT=21069 DEFAULT CHARSET=utf8;
...
CREATE TABLE `p8_letter_data` (
  ...
  `reply_department` smallint(5) NOT NULL DEFAULT '0',
...
CREATE TABLE `p8_letter_item` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `department` smallint(5) NOT NULL DEFAULT '0',
  ...
  `solve_name` varchar(30) NOT NULL DEFAULT '',
  ...
  `p8_ip` varchar(20) NOT NULL DEFAULT '',
  `custom_a` varchar(255) NOT NULL DEFAULT '',
  `custom_b` varchar(255) NOT NULL DEFAULT '',
  `custom_c` varchar(255) NOT NULL DEFAULT '',
  `custom_d` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE `p8_member` (
  ...
  `last_change_password` int(11) NOT NULL DEFAULT '0',
  ...
  `dept2` varchar(10) NOT NULL DEFAULT '',
  `find_pwd` varchar(255) NOT NULL DEFAULT '',
  `is_message_user` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `username` (`username`),
  KEY `email` (`email`),
  KEY `role_id` (`role_id`),
...
DROP TABLE IF EXISTS `p8_member_dept`;
CREATE TABLE `p8_member_dept` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `parent` smallint(5) unsigned NOT NULL DEFAULT '0',
  `name` varchar(40) NOT NULL DEFAULT '',
  `display_order` smallint(5) unsigned NOT NULL DEFAULT '0',
  `item_count` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `item_score` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `item_count_sites` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `item_score_sites` mediumint(8) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `p8_pay_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `order_NO` char(1) NOT NULL DEFAULT '',
...
CREATE TABLE `p8_role` (
  ...
  `role_template` varchar(50) NOT NULL DEFAULT '',
...
CREATE TABLE `p8_sites_category_recycle` (
  `id` mediumint(8) unsigned NOT NULL,
  `parent` smallint(5) unsigned NOT NULL DEFAULT '0',
  `matrix` smallint(5) unsigned NOT NULL DEFAULT '0',
  `name` varchar(60) NOT NULL DEFAULT '',
  `site` varchar(50) NOT NULL DEFAULT '',
  `letter` varchar(2) NOT NULL DEFAULT '',
  `model` varchar(20) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `p8_sites_menu_custom`;
CREATE TABLE `p8_sites_menu_custom` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `site` varchar(100) NOT NULL DEFAULT '',
  `name` char(30) NOT NULL DEFAULT '',
  `url` char(255) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `p8_sites_menu_nav`;
CREATE TABLE `p8_sites_menu_nav` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `site` varchar(50) NOT NULL DEFAULT '',
  `parent` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `name` char(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `url` char(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `target` char(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `display` tinyint(1) unsigned NOT NULL DEFAULT '1',
  `display_order` mediumint(8) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `p8_sites_menu_quick`;
CREATE TABLE `p8_sites_menu_quick` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `parent` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `name` char(30) NOT NULL DEFAULT '',
  `url` char(255) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `p8_sites_menu_user`;
CREATE TABLE `p8_sites_menu_user` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `uid` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `name` char(30) NOT NULL DEFAULT '',
  `url` char(255) NOT NULL DEFAULT '',
...
CREATE TABLE `p8_sms_data` (
  ...
  `timestramp` int(10) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
...
CREATE TABLE `p8_survey_item` (
  ...
  `content` text NOT NULL,
  `view_result` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `cookie` tinyint(1) unsigned NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `timestamp` (`timestamp`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
CREATE TABLE `p8_vote_` (
  ...
  `label_template` varchar(40) NOT NULL DEFAULT '',
  `content` text NOT NULL,
  `enabled` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `enabled_24` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `p8_word_censor_filter` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `p8_word_scan`;
CREATE TABLE `p8_word_scan` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `create_time` int(10) unsigned NOT NULL DEFAULT '0',
  `system` varchar(30) NOT NULL DEFAULT '',
  `module` varchar(30) NOT NULL DEFAULT '',
  ...
  `timestamp` int(10) unsigned NOT NULL DEFAULT '0',
  `uid` smallint(10) unsigned NOT NULL DEFAULT '0',
  `author` varchar(20) NOT NULL DEFAULT '',
  `site` varchar(30) NOT NULL DEFAULT '',
  `iid` int(10) unsigned NOT NULL DEFAULT '0',
  `model` varchar(20) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `p8_word_scan_filter`;
CREATE TABLE `p8_word_scan_filter` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `filter_word` char(40) NOT NULL DEFAULT '',
  `aid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `type` tinyint(1) NOT NULL DEFAULT '1',
