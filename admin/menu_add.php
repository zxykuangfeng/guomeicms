...
if(REQUEST_METHOD == 'GET'){
	...
	$data = $parent ? $admin_menu->view($parent) : array();
	...
	$menu_icon = empty($_POST['menu_icon']) ? 'fa-codepen' : $_POST['menu_icon'];
	$menu_sys = $parent ? $data['menu_sys'] : (empty($_POST['menu_sys']) ? 'main' : $_POST['menu_sys']);
	$admin_menu->add(
		array(
			'name' => $name,
			'parent' => $parent,
