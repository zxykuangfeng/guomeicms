...
if(REQUEST_METHOD == 'GET'){
    ...
    $config['stop_ip']['area_ip'] = isset($config['stop_ip']['area_ip']) ? explode("\r\n", trim($config['stop_ip']['area_ip'])) : array();
    $config['stop_ip']['area_ip'] = array_filter(array_map('trim',$config['stop_ip']['area_ip']));
