...
if(REQUEST_METHOD == 'GET'){
	...
	$this_system_ = $core->load_system('sites');
	$farm_module = $this_system_->load_module('farm');
	$templates = $farm_module->get_sites_templates();
	include template($core, 'template/template_sites', 'admin');
