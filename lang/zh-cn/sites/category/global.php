...
return array(
	...
	'sites_category_sitename' => '站点名称',
	'sites_category_model' => '模型',
	'sites_category_count' => '统计重点',
	...
	'sites_category_fix' => '重新统计内容数',
	'sites_category_frame' => '封面图片',
	'sites_category_list_title_length' => '栏目列表标题长度',
	'sites_category_list_title_dot' => '标题超过字数是否用省略号表示',
	'sites_category_htmlize' => '栏目没有开启静态，请您先开启静态！',
	'sites_category_need_select' => '请确定是否需要静态本站所有内容，点击确定即可',
	'sites_category_select' => '请先进入[栏目管理]-->底部按钮[开启网站静态]-->点击[开启所有栏目与内容静态]',
	...
	'sites_category_order_by_default' => '默认(发布时间)',
	'sites_category_order_by_views' => '点击率',
	'sites_category_order_by_timestamp' => '发布时间',
	'sites_category_order_by_listorder' => '排序时间',
	'sites_category_order_by_level' => '内容权重',
	...
	'sites_category_type_can_not_be_empty' => '栏目类型必须选择',
	'top_sites_category' => '顶级栏目',
	
	'sites_category_update_order' => '修改排序',
	...
	'sites_category_confirm_to_recycle' => '删除分类会连所属分类的内容移动到回收站,确认删除吗?',
	'sites_config'=>'基本设置',
