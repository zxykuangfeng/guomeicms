...
return array(
	...
	'mysql_config_err' => 'Error:请检查步骤1.MySQL数据库必须配置',
	'db_item_main2_inner_err' => 'Error:使用副表1，则副表1与主表的关联条件必填',
	'db_item_main3_inner_err' => 'Error:使用副表2，则副表2与主表或副表1的关联条件必填',
	'db_item_main_field_err' => 'Error:主表字段至少选择一项',
	'db_item_main2_field_err' => 'Error:副表1字段至少选择一项',
	'db_item_main3_field_err' => 'Error:副表2字段至少选择一项',
	'mysql_struct_err' => 'Error:请检查步骤2.当前选择的数据表为空表，请检查！',
	'mysql_db_member_err' => 'Error:请检查步骤2.数据表映射配置中“会员数据表”的配置！',
	'mysql_db_category_err' => 'Error:请检查步骤2.数据表映射配置中“栏目分类数据表”的配置！',
	'mysql_db_item_err' => 'Error:请检查步骤2.数据表映射配置中“内容数据表”的配置！',
	'member_import_result' => '成功导入{$1}个会员，失败会员{$2}人（{$3}）',
	'member_import_result2' => '成功导入{$1}个会员！',
	'category_import_result' => '成功导入{$1}个栏目！',
	'change_system_err' => '切换对接系统后，请设置参数后再操作!',
	'spider' => array(
		'rule' => array(
			'' => '采集规则',
			'add' => '添加采集规则',
