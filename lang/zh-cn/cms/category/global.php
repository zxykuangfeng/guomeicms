...
return array(
	...
	'update_cms_category' => '栏目配置',
	'menu_display' => '是否显示',
	'cms_category_model' => '内容模型',
	...
	'cms_category_item_template' => '栏目列表标签样式',
	'cms_category_item_count' => '内容数',
	'cms_category_merge' => '合并栏目',
	'cms_category_clone' => '克隆栏目',
	'cms_category_clone_to' => '选择克隆到哪个栏目',
	'cms_category_fix' => '重新统计内容数',
	'cms_category_frame' => '栏目封面图片',
	'cms_category_list_title_length' => '栏目列表标题长度',
	'cms_category_list_title_dot' => '标题超过字数是否用省略号表示',	
	'cms_category_htmlize' => '请先进入[栏目管理]-->底部按钮[开启网站静态]-->点击[开启所有栏目与内容静态]',
	'cms_category_need_select' => '请先选择相关栏目！',
	'cms_category_select' => '请先进入[栏目管理]-->底部按钮[开启网站静态]-->点击[开启所有栏目与内容静态]',
	...
	'cms_category_type_4' => '单网页',
	'cms_category_type_4_s' => '单网页',
	'cms_category_outlink' => '外链地址',
	'cms_category_outlink_can_not_be_empty' =>'链接地址不能为空',
	'cms_category_outlink_note' => '前面要加上http://',
	'cms_category_domain_note' => '域名格式: http://news.168.com 后面不带/。绑定后去你的DNS那里绑定二级域名到分类的目录，目录即是“静态页存放路径”一栏{$DOCUMENT_ROOT}的后面那段，URL规则一定要使用{$category_url}才行。如果本分类中有子分类的话，子分类将自动继承域名配置。',
	'cms_category_set_htmlize_fail' => '操作成功！检测到以下字段设置为列表页过滤字段：{$1}，栏目静态化状态设置成功，但将不可生成静态！',
	'cms_category_content_orderby' => '列表页排序',
	'cms_category_sun_orderby' => '子栏目排序方式',
	'cms_category_order_by_default' => '默认(发布时间)',
	'cms_category_order_by_timestamp' => '发布时间',
	'cms_category_order_by_listorder' => '排序时间',
	'cms_category_order_by_views' => '点击率',
	'cms_category_order_by_level' => '内容权重',
	...
	'cms_category_html_path_note' => '如果静态列表、内容页规则不使用{$category_url}的话将不起作用，如果你要将分类绑定域名，并且让子分类继承域名，一定要把HTML URL规则配置成{$category_url}的路径',
	...
	'cms_category_confirm_to_recycle' => '删除分类会连所属分类的内容移动到回收站,确认删除吗?',
	
	'cms_config'=>'基本配置',
	'cms_config_style'=>'风格配置',
    'cms_config_authority'=>'权限配置',
	'cms_config_other'=>'其它配置',
	'htmlstatus'=>'静态化',
