...
if($mail_setting['mailsend'] == 1 && function_exists('mail')) {
	...
	$headers .= 'Message-ID: <'.gmdate('YmdHs').'.'.substr(md5($mail['message'].microtime()), 0, 6).rand(100000, 999999).'@'.$_SERVER['SERVER_PORT']=='80' ? $_SERVER['SERVER_NAME']:$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'].">{$maildelimiter}";
