...
function b2g( $instr ) {
	...
	$fp = fopen( PHP168_PATH .'inc/charset_tab/big5-gb.tab', 'r' );
...
function g2b( $instr ) {
	...
	$fp = fopen( PHP168_PATH .'inc/charset_tab/gb-big5.tab', 'r' );
...
function b2u( $instr ) {
	$fp = fopen( PHP168_PATH .'inc/charset_tab/big5-unicode.tab', 'r' );
	$len = strlen($instr);
	$outstr = '';
	for( $i = $x = 0 ; $i < $len ; $i++ ) {
		$h = ord($instr[$i]);
...
function u2b( $instr ) {
	$fp = fopen( PHP168_PATH .'inc/charset_tab/unicode-big5.tab', 'r' );
	$len = strlen($instr);
	$outstr = '';
	for( $i = $x = 0 ; $i < $len ; $i++ ) {
		$b1 = ord($instr[$i]);
...
function g2u( $instr ) {
	$fp = fopen( PHP168_PATH .'inc/charset_tab/gb-unicode.tab', 'r' );
	$len = strlen($instr);
	$outstr = '';
	for( $i = $x = 0 ; $i < $len ; $i++ ) {
		$h = ord($instr[$i]);
...
function u2g( $instr ) {
	$fp = fopen( PHP168_PATH .'inc/charset_tab/unicode-gb.tab', 'r' );
	$len = strlen($instr);
	$outstr = '';
	for( $i = $x = 0 ; $i < $len ; $i++ ) {
		$b1 = ord($instr[$i]);
